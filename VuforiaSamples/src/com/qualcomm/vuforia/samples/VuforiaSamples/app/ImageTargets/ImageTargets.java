...
public class ImageTargets extends Activity implements SampleApplicationControl, SampleAppMenuInterface {
	...
	// Variable used to know if an object is tracked or not
	...
	private void populateMap(){
		// Dream Book
		urlMap.put("DreamBook_0607","http://www.ascona-locarno.com/en/");
		urlMap.put("DreamBook_1011","http://www.lugano.ch/");
		urlMap.put("DreamBook_1415","http://www.mendrisiottoturismo.ch/");
		urlMap.put("DreamBook_1819","http://www.bellinzonaturismo.ch/it/castelli.aspx");
		urlMap.put("DreamBook_2223","http://www.pardolive.ch/en/");
		urlMap.put("EscursioniNatura_0607","http://www.ticino.ch");
		urlMap.put("EscursioniNatura_0809","http://www.ticino.ch");
		urlMap.put("EscursioniNatura_1011","http://www.ticino.ch");
		urlMap.put("EscursioniNatura_3435","http://www.ticino.ch");
		urlMap.put("EscursioniNatura_3839","http://www.ticino.ch");
		//urlMap.put("EscursioniNatura_4243","www.ticino.ch");
		urlMap.put("EscursioniNatura_4647","http://www.ticino.ch");
		urlMap.put("EscursioniNatura_5051","http://www.ticino.ch");
	}

	public void isObjectTracked(boolean isTracked, String objectName) {
		this.isTracked = isTracked;
		String url = urlMap.get(objectName);
		if(objectName.equals("noObject"))
			url = "www.google.it";
	...
	private class GestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onSingleTapUp(MotionEvent e) {
			if (isTracked) {
				Log.d(LOGTAG, "Object tracket, url :" + objectUrl);
				try {
					Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(objectUrl));
					startActivity(myIntent);
				} catch (ActivityNotFoundException exc) {
					Toast.makeText(ImageTargets.this,
	...
	private void loadTextures() {
		mTextures.add(Texture.loadTextureFromApk("TextureMoreInfo.png", getAssets()));
	}
	...
	public void onQCARUpdate(State state) {
		if (mSwitchDatasetAsap) {
			...
			ImageTracker it = (ImageTracker) tm.getTracker(ImageTracker.getClassType());
			if (it == null || mCurrentDataset == null || it.getActiveDataSet() == null) {
			...
			case CMD_CAMERA_REAR :
				...
				try {
					vuforiaAppSession.startAR(command == CMD_CAMERA_FRONT
							? CameraDevice.CAMERA.CAMERA_FRONT
