...
public class ImageTargetRenderer implements GLSurfaceView.Renderer {
	...
	private void renderFrame() {
		...
		for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
			...
			// TODO Qui dobbiamo aggiungere gliindex alle immagini da
			// riconoscere
			...
			if (!mActivity.isExtendedTrackingActive()) {
				...
				GLES20.glDrawElements(GLES20.GL_TRIANGLES, mCube.getNumObjectIndex(), GLES20.GL_UNSIGNED_SHORT,
						mCube.getIndices());
		...
		if (state.getNumTrackableResults() == 1) {
			// TODO set object tracked
			mActivity.isObjectTracked(true, objectName);
		} else {
			mActivity.isObjectTracked(false, "noObject");
		}
